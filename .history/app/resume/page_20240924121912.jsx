...
const skills = {
  title: "My Skills",
  description: "Web Development: Proficient in building responsive, dynamic web applications.UI/UX Design: Skilled in creating user-friendly interfaces and seamless user experiences.Styling Frameworks: Expertise in utilizing advanced styling techniques for efficient and scalable design.",
  description2: "",
  skillList: [
    {
      icon: <FaHtml5 />,
