...
const skills = {
  title: "My Skills",
  description: "Web Development: Proficient in building responsive, dynamic web applications.
UI/UX Design: Skilled in creating user-friendly interfaces and seamless user experiences.
Back-end Development: Experienced in handling server-side logic and database integration.
