      ...
      <div className="container mx-auto">
        <Tabs defaultValue="experience" className="flex flex-col xl:flex-row gap-[60px] ">
          <TabsList className="flex flex-col w-full max-w-[380px] mx-auto xl:mx-0 gap-6">
            <TabsTrigger value="experiene">Experience</TabsTrigger>
            <TabsTrigger value="experiene">Education</TabsTrigger>
            <TabsTrigger value="experiene">Skills</TabsTrigger>
            <TabsTrigger value="experiene">About me</TabsTrigger>
          </TabsList>
