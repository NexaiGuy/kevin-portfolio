      ...
      <div className="container mx-auto">
        <Tabs defaultValue="experience" className="flex flex-col xl:flex-row gap-[60px] ">
          <TabsList className="flex flex-col w-full max-w-[380px] mx-auto xl:mx-0 gap-6">
            <TabsTrigger value="exper">Experience</TabsTrigger>
            <TabsTrigger value="exper">Education</TabsTrigger>
            <TabsTrigger value="exper">Skills</TabsTrigger>
            <TabsTrigger value="exper">About me</TabsTrigger>
          </TabsList>
