...
const skills = {
  ...
  description2: "Back-end Development: Experienced in handling server-side logic and database integration.Styling Frameworks: Expertise in utilizing advanced styling techniques for efficient and scalable design.",
  skillList: [
    {
      icon: <FaHtml5 />,
      name: "html 5",
